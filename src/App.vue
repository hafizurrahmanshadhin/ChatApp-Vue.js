...
<div class="bg-gray-100 h-screen flex flex-col max-w-lg mx-auto">
    ...
    <div class="flex-1 overflow-y-auto p-4">
        <div class="flex flex-col space-y-2">
           ...
           <template v-for="message in messages" :key="message.id">
              <div class="flex" :class="[message.sender_id === user.id ? 'justify-end' : 'justify-start']">
    ...
    <div class="bg-white p-4 flex items-center">
        <input type="text" v-model="message" placeholder="Type your message..." class="flex-1 border rounded-full px-4 py-2 focus:outline-none">
...
export default {
  ...
  methods: {
   ...
   console.log(response)
          ...
          axios.get('http://localhost:8000/api/messages/2').then(response => {
            this.messages = response.data
            console.log(response.data);
          });
        }).then(() => {

          this.echo.channel(`chat-channel.1`)
  ...
  //           'bearer': 'Bearer 5|WYl9SvKDd9d18I7rNKUaKwSrWpBFIMo7yI8F0819a2c6f8a8'
  //         },
  //       });
